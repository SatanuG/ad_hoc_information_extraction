...
class MPEA(BaseModel):
    ...
    microstructure: Optional[str] = Field(
        ..., description="The microstructure of a material is the arrangement of its internal structure.")

    processing_method: Optional[str] = Field(
        ..., description="The processing method of a material is the method used to create the material.")

    bcc_fcc_other: Optional[str] = Field(
        ..., description="The BCC/FCC/other of a material is the type of crystal structure the material has.")

    type_of_test: Optional[str] = Field(
        ..., description="The type of test of a material is the type of test that was performed on the material.")

    experimental_young_modulus: Optional[float] = Field(
        ..., description="The experimental young modulus of a material is the modulus of elasticity of the material.")

    oxygen_content: Optional[float] = Field(
        ..., description="The oxygen content of a material is the amount of oxygen in the material.")

    nitrogen_content: Optional[float] = Field(
        ..., description="The nitrogen content of a material is the amount of nitrogen in the material.")

    carbon_content: Optional[float] = Field(
        ..., description="The carbon content of a material is the amount of carbon in the material.")
...
def run():
    ...
    for i, entry in enumerate(collection):
        ...
        try:
            ...
            with open(f"./extracted_info/langchain_0shot_complex/{entry['doi'].replace('/', '.')}.jsonl", "w") as f:
